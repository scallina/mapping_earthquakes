...
var TectonicLink = "static/data/tectonicPlatesData.geojson";
var majorsLink = "static/data/major_earthquakes.geojson";

let allEarthquakes = new L.LayerGroup();
let allTectonicPlates = new L.LayerGroup();
let allMajors = new L.LayerGroup();
...
// Retrieve the earthquake GeoJSON data.
d3.json(majorsLink).then(function(data) {
  // This function returns the style data for each of the earthquakes we plot on
  // the map. We pass the magnitude of the earthquake into two separate functions
  // to calculate the color and radius.
  function styleInfo(feature) {
